...
Хочу сделать оптимальную передачу данных 

Оптимально думаю будет так 
```json
[
  {"user_id": 73123123,
   "content": { 
              "wall":  ["Какой-то текст",
                        "Какой-то текст 2"],
              "photos": {
                        "wall": ["someUrl", "somerul2"],
                        "saved": ["someUrl", "someUrl3"]
                        },
              "friends": [
                          {"user_id": 3123213,
                           "content": {
              ...
              "groups": [
                          {"group_id": -788494,
                           "content": {
                                        "wall": ["Какой-то текст группы","Какой-то текст группы 2"],
                                        "photos": {
                                                    "wall": ["url1", "url2"],
                                                    "albums": ["url3", "url4"]
                                                  },
                                        "members": [13123123,13123123123,41123123,131231123]
                                      }                               
                          }
                        ]           
              } 
...
Разделим по несколим сценариям.
1. Анализ деятельности пользователя
2. Получить все посты
3. Получить все фотографии
